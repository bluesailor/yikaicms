...
INSERT INTO "yikai_roles" ("id", "name", "name_en", "name_ja", "description", "description_en", "description_ja", "permissions", "status", "created_at") VALUES (2,'投稿者','Contributor','投稿者','仅可撰写文章并插图，不能删除内容','Write and illustrate articles only; cannot delete','記事の作成と画像挿入のみ（削除不可）','["edit_article"]',1,1776652898);
