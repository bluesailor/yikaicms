...
<li>50+ 人专业研发团队</li>
<li>7×24 小时技术支持</li>
</ul>','blocks','[{"id":"s","settings":{"bg_color":"","bg_image":"","padding":"xl","max_width":"narrow","align_items":"","justify_items":"","gap":"lg"},"columns":[{"id":"c","elements":[{"id":"e","type":"heading","data":{"text":"以技术与品质，做客户长期的伙伴","level":"h1","align":"center"}},{"id":"e","type":"text","data":{"html":"<p style=\"text-align:center;font-size:1.05rem;line-height:1.9;color:#4b5563\">我们专注于工业智能设备的研发与制造，产品覆盖传感器模块、控制终端与配套软件系统。成立十余年来，为国内外三千余家客户提供稳定可靠的产品与服务，并在多个细分领域建立了长期合作关系。</p>"}}]}]},{"id":"s","settings":{"bg_color":"#f8fafc","bg_image":"","padding":"md","max_width":"default","align_items":"","justify_items":"","gap":"md"},"columns":[{"id":"c","elements":[{"id":"e","type":"icon-box","data":{"icon":"calendar-stats","title":"12 年","text":"深耕行业"}}]},{"id":"c","elements":[{"id":"e","type":"icon-box","data":{"icon":"users-group","title":"3000+","text":"服务客户"}}]},{"id":"c","elements":[{"id":"e","type":"icon-box","data":{"icon":"certificate","title":"32 项","text":"技术专利"}}]},{"id":"c","elements":[{"id":"e","type":"icon-box","data":{"icon":"world","title":"26 国","text":"产品出口"}}]}]},{"id":"s","settings":{"bg_color":"","bg_image":"","padding":"xl","max_width":"default","align_items":"center","justify_items":"","gap":"lg"},"columns":[{"id":"c","elements":[{"id":"e","type":"image","data":{"src":"/uploads/images/case-demo.jpg","alt":"生产车间与研发中心","click_action":"lightbox","link_url":"","link_new_tab":false}}]},{"id":"c","elements":[{"id":"e","type":"heading","data":{"text":"从一间实验室，到一条完整产线","level":"h2","align":"left"}},{"id":"e","type":"text","data":{"html":"<p style=\"line-height:1.9;color:#4b5563\">创立之初，我们只有一间不足百平米的实验室和五名工程师。凭借在信号采集与边缘计算上的持续投入，逐步建立起自主的硬件设计、固件开发与整机制造能力。</p><p style=\"line-height:1.9;color:#4b5563\">今天，公司拥有两座生产基地与一支八十余人的研发团队，从元器件选型到成品出厂全流程自控，确保交付品质稳定可追溯。</p>"}},{"id":"e","type":"button","data":{"text":"查看发展历程","url":"/about/history.html","new_tab":false}}]}]},{"id":"s","settings":{"bg_color":"","bg_image":"","padding":"xl","max_width":"default","align_items":"","justify_items":"","gap":"lg","col_card":true,"title":"为什么选择我们","subtitle":"不只是供货，更是把问题一起解决"},"columns":[{"id":"c","elements":[{"id":"e","type":"icon-box","data":{"icon":"cpu","title":"自主研发","text":"核心算法与固件全部自研，可根据场景做深度定制，不受第三方方案掣肘。"}}]},{"id":"c","elements":[{"id":"e","type":"icon-box","data":{"icon":"shield-check","title":"品质可追溯","text":"每台设备留有完整生产与检测记录，出厂前经 72 小时连续老化测试。"}}]},{"id":"c","elements":[{"id":"e","type":"icon-box","data":{"icon":"headset","title":"响应及时","text":"技术支持一个工作日内响应，重点客户提供驻场与远程双通道服务。"}}]}]},{"id":"s","settings":{"bg_color":"#f8fafc","bg_image":"","padding":"lg","max_width":"narrow","align_items":"","justify_items":"","gap":"lg"},"columns":[{"id":"c","elements":[{"id":"e","type":"quote","data":{"text":"设备在我们车间连续运行两年多没出过一次非计划停机，偶尔的固件升级也都是他们主动推过来的。这种省心，比参数表上的数字更值钱。","author":"某汽车零部件制造企业 · 设备部经理"}}]}]},{"id":"s","settings":{"bg_color":"","bg_image":"","padding":"xl","max_width":"narrow","align_items":"","justify_items":"","gap":"lg","title":"常见问题"},"columns":[{"id":"c","elements":[{"id":"e","type":"accordion","data":{"items":"能否针对我们的产线做定制开发？|可以。我们提供从接口协议适配到整机结构的定制服务，通常在需求确认后 4-6 周内交付首台样机。\n产品的质保期是多久？|标准整机质保两年，核心模块三年。质保期外提供终身有偿维修与技术支持。\n是否支持海外发货与本地化认证？|支持。产品已通过 CE、FCC、RoHS 认证，可协助客户完成目的国的入关与合规手续。\n如何获取选型建议？|把使用场景、测量范围与环境条件告诉我们，工程师会在一个工作日内给出选型方案与报价。","open_first":true,"seo_schema":true}}]}]},{"id":"s","settings":{"bg_color":"","bg_image":"","padding":"lg","max_width":"default","align_items":"","justify_items":"","gap":"lg"},"columns":[{"id":"c","elements":[{"id":"e","type":"cta","data":{"title":"想了解我们能为你做什么？","text":"告诉我们你的使用场景，工程师会在一个工作日内给出建议与报价。","btn_text":"联系我们","btn_url":"/contact.html"}}]}]}]','','','','',0,0.00,NULL,'','',NULL,'','','','',0,0,0,0,0,'','','',1,0,1776652898,1776652898,1776652898,1,'','','','');
