...
INSERT INTO "yikai_roles" ("id", "name", "name_en", "name_ja", "description", "description_en", "description_ja", "permissions", "status", "created_at") VALUES (2,'投稿者','Contributor','投稿者','仅可撰写文章，不能删除或上传媒体','Write articles only; cannot delete or upload media','記事の作成のみ（削除・メディア不可）','["edit_article"]',1,1776652898);
INSERT INTO "yikai_roles" ("id", "name", "name_en", "name_ja", "description", "description_en", "description_ja", "permissions", "status", "created_at") VALUES (3,'内容编辑','Editor','編集者','编辑各类内容并上传媒体（不含删除）','Edit all content and upload media (no delete)','各種コンテンツの編集とメディア（削除不可）','["edit_article","edit_product","edit_case","edit_download","edit_page","media"]',1,1776652898);
INSERT INTO "yikai_roles" ("id", "name", "name_en", "name_ja", "description", "description_en", "description_ja", "permissions", "status", "created_at") VALUES (4,'内容主管','Content Manager','コンテンツ管理者','各类内容的增删改与媒体','Full content management incl. delete','コンテンツの追加・編集・削除とメディア','["edit_article","edit_product","edit_case","edit_download","edit_page","delete_article","delete_product","delete_case","delete_download","delete_page","media"]',1,1776652898);
INSERT INTO "yikai_roles" ("id", "name", "name_en", "name_ja", "description", "description_en", "description_ja", "permissions", "status", "created_at") VALUES (5,'运营','Operations','運営','内容主管 + 横幅/友链/表单/会员','Content Manager plus banner/link/form/member','コンテンツ管理者＋バナー/リンク/フォーム/会員','["edit_article","edit_product","edit_case","edit_download","edit_page","delete_article","delete_product","delete_case","delete_download","delete_page","media","banner","link","form","member"]',1,1776652898);
...
INSERT INTO "yikai_settings" ("id", "group", "key", "value", "type", "name", "tip", "options", "sort_order") VALUES (108,'system','cms_version','1.12.10','text','CMS版本号','',NULL,1);
