...
test('a banner slide can switch to video with poster-first mobile fallback @ci', async ({ page }, testInfo) => {
  ...
  const labels = {
    'zh-CN': { video: '视频', poster: '只显示封面', play: '播放视频', tooLarge: '超过站点上限' },
    en: { video: 'Videos', poster: 'Show poster only', play: 'Play video', tooLarge: 'exceeding the site limit' },
    ja: { video: '動画', poster: 'ポスターのみ表示', play: '動画を再生', tooLarge: 'サイトの上限' },
