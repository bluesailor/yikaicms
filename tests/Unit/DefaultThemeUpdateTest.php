...
final class DefaultThemeUpdateTest extends TestCase
{
    ...
    {
        $result = $this->installer()->install($this->zip, 'default', '1.0.6', 'official', $this->signature);
        ...
        self::assertSame('default_protected', $this->installer()->install($this->zip, 'default', '1.0.6', 'official', $this->signature)['code']);
    }

    public function testUnsignedWrongSignatureWrongContextAndTamperedBytesAreRejected(): void
    {
        foreach ([['', '', 'local', ''], ['default', '1.0.6', 'official', ''], ['default', '1.0.6', 'official', base64_encode('fake')],
            ['minimal', '1.0.6', 'official', $this->signature], ['default', '1.0.7', 'official', $this->signature]] as $args) {
    ...
    public function testActivationFailureRestoresDefaultInsteadOfLeavingSiteWithoutFallback(): void
    {
        ...
        $result = $this->installer($rename)->install($this->zip, 'default', '1.0.6', 'official', $this->signature);
