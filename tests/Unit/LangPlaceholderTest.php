 ...
 * 中文「关于Acme」读得通，英文站就渲染成「AboutAcme Lighting」——
...
final class LangPlaceholderTest extends TestCase
{
     ...
     * 否则「About」+「Acme」会粘成「AboutAcme」。
     * 中日文不做此要求——「关于Acme」正是期望的读法。
     */
    ...
    public function testAboutTitleComposesCleanlyInEveryLanguage(): void
    {
        $site = 'Acme Lighting';
        $expected = [
            'zh-CN' => '关于Acme Lighting',
            'en'    => 'About Acme Lighting',
            'ja'    => 'Acme Lighting について',
        ];
