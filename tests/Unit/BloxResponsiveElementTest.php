...
final class BloxResponsiveElementTest extends TestCase
{
    ...
    public function testResponsiveControlsAreDeclaredInElementSchemas(): void
    {
        foreach ([
            ...
            [new ContainerElement(), ['direction', 'gap', 'gap_px', 'row_gap_px', 'column_gap_px',
                'align', 'justify', 'align_content', 'padding', 'order_n', 'flex_basis_px']],
            [new DivElement(), ['direction', 'gap', 'gap_px', 'row_gap_px', 'column_gap_px',
                'align', 'justify', 'align_content', 'padding', 'order_n', 'flex_basis_px']],
        ] as [$element, $keys]) {
            $responsive = [];
