...
try {
    ...
    $pdo->exec('CREATE TABLE contents (id INTEGER PRIMARY KEY AUTOINCREMENT, channel_id INTEGER NOT NULL, lang TEXT NOT NULL DEFAULT \'en\', status INTEGER NOT NULL DEFAULT 1, deleted_at INTEGER, is_top INTEGER NOT NULL DEFAULT 0, publish_time INTEGER NOT NULL DEFAULT 0, content_type TEXT NOT NULL DEFAULT \'html\', content TEXT, blocks_data TEXT, updated_at INTEGER NOT NULL DEFAULT 0)');
