...
return [
    ...
    'url' => [
        'url_mode' => [
            ...
            'type' => 'radio',
            'name' => 'URL访问模式',
            'tip' => '漂亮URL需要服务器 Rewrite；动态URL通过 index.php 工作，不依赖 Rewrite。切换后新生成的站内链接立即采用新模式。',
            'options' => '{"pretty":"漂亮URL（需要Rewrite）","query":"动态URL（无需Rewrite）"}',
            'section' => 'URL 与链接',
            'sort_order' => 0,
        ],
    ],
    ...
    'footer' => [
        ...
        'footer_bg_color'       => ['value' => '#0F172A', 'type' => 'color', 'name' => '背景色', 'tip' => '', 'sort_order' => 2],
    ...
    'home' => [
        ...
        'home_stat_2_num'           => ['value' => '1200+', 'type' => 'text', 'name' => '统计数值2', 'tip' => '', 'sort_order' => 7],
        'home_stat_2_text'          => ['value' => '服务客户', 'type' => 'text', 'name' => '统计文字2', 'tip' => '', 'sort_order' => 8],
        'home_stat_3_num'           => ['value' => '60+', 'type' => 'text', 'name' => '统计数值3', 'tip' => '', 'sort_order' => 9],
        'home_stat_3_text'          => ['value' => '专业团队', 'type' => 'text', 'name' => '统计文字3', 'tip' => '', 'sort_order' => 10],
        'home_stat_4_num'           => ['value' => '98%', 'type' => 'text', 'name' => '统计数值4', 'tip' => '', 'sort_order' => 11],
        'home_stat_bg'              => ['value' => '', 'type' => 'image', 'name' => '统计区块背景', 'tip' => '统计横栏的背景图', 'sort_order' => 12],
        'home_stat_4_text'          => ['value' => '客户满意度', 'type' => 'text', 'name' => '统计文字4', 'tip' => '', 'sort_order' => 12],
    ...
    'system' => [
        ...
        'onboarding_start_dismissed' => ['value' => '1', 'type' => 'switch', 'name' => '控制台开始建站引导', 'tip' => '仅全新安装写入待显示状态，旧站升级默认不显示', 'sort_order' => 14],
        'onboarding_start_done' => ['value' => '', 'type' => 'json', 'name' => '开始建站已完成步骤', 'tip' => '系统自动维护，请勿手动修改', 'sort_order' => 15],
    ],
