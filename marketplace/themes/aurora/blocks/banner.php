    ...
    <div class="container mx-auto px-6 lg:px-8 relative z-10 py-20">
        <div class="max-w-3xl"<?php echo !empty($banners[0]['_blox_path']) ? ' data-yk-el="' . e($banners[0]['_blox_path']) . '" data-yk-el-type="home-banner-item"' : ''; ?>>
            <?php if (!empty($banners)): ?>
                ...
                <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium text-indigo-300 bg-indigo-500/10 border border-indigo-500/20 mb-6" data-blox-layer style="--blox-layer-order:0">
                    <span class="w-1.5 h-1.5 rounded-full bg-indigo-400 animate-pulse"></span>
                    <?php echo e($heroBanner['subtitle']); ?>
                </div>
                <?php endif; ?>
                <h1 class="text-4xl md:text-6xl font-bold tracking-tight text-white leading-[1.1] mb-6" data-blox-layer style="--blox-layer-order:1">
                    <?php
                ...
                <p class="text-lg text-slate-400 leading-relaxed mb-10 max-w-2xl" data-blox-layer style="--blox-layer-order:2">
                    <?php echo e($heroBanner['description']); ?>
                </p>
                <?php endif; ?>
                <div class="flex flex-wrap items-center gap-4" data-blox-layer style="--blox-layer-order:3">
