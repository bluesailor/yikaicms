    ...
    <div class="<?= e($surface['container'] . ' ' . $surface['content']) ?>">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center" data-stagger>
            <div>
                ...
                <div<?php echo $_homeFieldAttr('stats_items.0.label'); ?> class="business-copy"><?php echo e(configLang('home_stat_1_text', 'home_stat_1')); ?></div>
            </div>
            <div>
                ...
                <div<?php echo $_homeFieldAttr('stats_items.1.label'); ?> class="business-copy"><?php echo e(configLang('home_stat_2_text', 'home_stat_2')); ?></div>
            </div>
            <div>
                ...
                <div<?php echo $_homeFieldAttr('stats_items.2.label'); ?> class="business-copy"><?php echo e(configLang('home_stat_3_text', 'home_stat_3')); ?></div>
            </div>
            <div>
                ...
                <div<?php echo $_homeFieldAttr('stats_items.3.label'); ?> class="business-copy"><?php echo e(configLang('home_stat_4_text', 'home_stat_4')); ?></div>
            </div>
        </div>
    </div>
</section>
