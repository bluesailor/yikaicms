            ...
            <div class="swiper-slide relative"<?php echo HomeBannerItemElement::motionAttributes($banner); ?><?php echo !empty($banner['_blox_path']) ? ' data-yk-el="' . e($banner['_blox_path']) . '" data-yk-el-type="home-banner-item"' : ''; ?>>
                ...
                <div class="absolute inset-0 hero-overlay flex items-center justify-center" data-blox-banner-content<?php echo class_exists('BannerContentLayout') ? BannerContentLayout::attributes($banner ?? [], $block ?? []) : ''; ?>>
                    <div class="text-center text-white px-4 w-full max-w-4xl" data-blox-banner-box>
                        ...
                        <div data-blox-banner-buttons><a href="<?php echo e($banner['btn1_url'] ?: '/contact.html'); ?>" class="inline-block bg-primary hover:bg-secondary text-white px-8 py-3 rounded-full text-lg font-medium transition" data-blox-layer style="--blox-layer-order:2">
            ...
            <div class="swiper-slide relative">
                ...
                <div class="absolute inset-0 hero-overlay flex items-center justify-center" data-blox-banner-content<?php echo class_exists('BannerContentLayout') ? BannerContentLayout::attributes($banner ?? [], $block ?? []) : ''; ?>>
                    <div class="text-center text-white px-4 w-full max-w-4xl" data-blox-banner-box>
                        ...
                        <div data-blox-banner-buttons><a href="/contact.html" class="inline-block bg-primary hover:bg-secondary text-white px-8 py-3 rounded-full text-lg font-medium transition" data-blox-layer style="--blox-layer-order:2"><?php echo __('detail_consult'); ?></a></div>
                    </div>
                </div>
            </div>
            <?php endif; ?>
