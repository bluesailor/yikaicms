...
require_once __DIR__ . '/random_logo.php'; // 声明自身依赖（admin.php 已引入，require_once 幂等）
...
?>
<link rel="stylesheet" href="/plugins/logo-maker/random-logo.css?v=20260812a">
...
<div class="im-random-lab">
    ...
    <div class="im-random-layout">
        ...
        <div class="im-random-candidates" data-im-random-candidates data-im-order-message="<?php echo e(__('logo_maker_candidate_moved')); ?>" role="list">
            <?php for ($i = 0; $i < 12; $i++):
                $svgUrl = $imRandomSvgUrl($i);
                $resolvedEffect = logoMakerRandomResolveEffect($imRandomIndustry, $imRandomName, $imRandomSeed, $i, $imRandomEffect);
            ...
            ?>
                <article class="im-random-candidate" data-im-random-candidate="<?php echo $i; ?>" role="listitem">
                    <div class="im-random-candidate-tools">
                        <span><?php echo e(__('logo_maker_candidate_label', ['n' => str_pad((string) ($i + 1), 2, '0', STR_PAD_LEFT)])); ?></span>
                        <button type="button" class="im-random-drag-handle" title="<?php echo e(__('logo_maker_candidate_drag')); ?>" aria-label="<?php echo e(__('logo_maker_candidate_drag_aria', ['n' => $i + 1])); ?>">
