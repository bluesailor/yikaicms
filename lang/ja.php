...
return [
    ...
    'admin_theme' => 'テーマ',
    'admin_plugin' => 'プラグイン',
    'admin_recipe' => 'レシピ / サイトテンプレート',
    'recipe_intro_title' => 'レシピシステムについて',
    'recipe_intro_body' => 'レシピは、作成する栏目構成・カスタムフィールド・サンプルコンテンツ・設定項目を宣言する JSON マニフェストです。ワンクリックで業務骨格を立ち上げられます。レシピは /recipes/{slug}/recipe.json に配置し、適用は冪等（既存の栏目は slug 単位でスキップまたは更新）です。',
    'recipe_available' => '利用可能なレシピ',
    'recipe_scan_hint' => '/recipes/ ディレクトリをスキャン、合計 :count 件',
    'recipe_empty' => 'レシピがありません。/recipes/ にサブディレクトリを作成し recipe.json を配置してください。',
    'recipe_count_channels' => '栏目 :n',
    'recipe_count_extfields' => 'フィールド :n',
    'recipe_count_contents' => 'コンテンツ :n',
    'recipe_count_settings' => '設定 :n',
    'recipe_apply' => 'このレシピを適用',
    'recipe_apply_success' => 'レシピを適用しました',
    'recipe_apply_failed' => '適用に失敗しました',
    'recipe_applying' => '適用中...',
    'recipe_confirm_title' => 'レシピ適用の確認',
    ...
    'recipe_export_title' => '現在のサイトをレシピとして書き出す',
    'recipe_export_desc' => '現在の channels + カスタムフィールド + 設定を JSON レシピパックに直列化します。他サイトへのクローン、または新規テンプレートの出発点に。',
    'recipe_export_name' => 'レシピ名',
