...
<?php endif; ?>
    ...
    <style>:root { --color-primary: <?php echo config('primary_color', '#0EA5A4'); ?>; --color-secondary: <?php echo config('secondary_color', '#0F766E'); ?>; }</style>
...
<body class="trade-theme bg-white min-h-screen flex flex-col">
    <!-- top banner -->
