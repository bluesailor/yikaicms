    ...
    <div class="<?php echo $bg['container']; ?> <?php echo $bg['content']; ?>">
        ...
        <div class="grid <?php echo $productGrid; ?> gap-6" id="productGrid">
            ...
            <a href="<?php echo productUrl($item); ?>" class="product-item block u-card group" data-category="<?php echo $item['category_id'] ?? 0; ?>">
                <div class="relative overflow-hidden aspect-[4/3]">
                    <?php if ($item['cover']): ?>
                    <img loading="lazy" decoding="async" <?php echo responsiveImageAttributes($item['cover'], 'medium', '(min-width: 1280px) 25vw, (min-width: 768px) 33vw, 100vw'); ?> alt="<?php echo e($item['title']); ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                    <?php else: ?>
        ...
        <div class="grid <?php echo $caseGrid; ?> gap-8">
            ...
            <a href="<?php echo contentUrl($item); ?>" class="block u-card group">
                <div class="relative overflow-hidden aspect-[4/3]">
                    <?php if ($item['cover']): ?>
                    <img loading="lazy" decoding="async" <?php echo responsiveImageAttributes($item['cover'], 'medium', '(min-width: 1280px) 33vw, (min-width: 768px) 50vw, 100vw'); ?> alt="<?php echo e($item['title']); ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                    <?php else: ?>
                    <div class="w-full h-full bg-gray-200 flex items-center justify-center text-gray-400">
                        <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
        ...
        <div class="grid <?php echo $articleGrid; ?> gap-6">
            ...
            <a href="<?php echo $itemUrl; ?>" class="block u-card group">
                ...
                <?php if ($item['cover']): ?>
                    <img loading="lazy" decoding="async" <?php echo responsiveImageAttributes($item['cover'], 'medium', '(min-width: 1280px) 25vw, (min-width: 768px) 50vw, 100vw'); ?> alt="<?php echo e($item['title']); ?>" class="w-full h-full object-cover group-hover:scale-110 transition duration-500">
                <?php else: ?>
