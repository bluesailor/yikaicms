...
<section class="blk <?php echo $bg['class']; ?>" <?php echo $bg['style']; ?>>
    ...
    <div class="<?php echo $bg['container']; ?> text-center <?php echo $bg['content']; ?>" data-animate="fade-up">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            <a href="<?php echo e(config('home_cta_link', '') ?: '/contact.html'); ?>" class="bg-white text-primary hover:bg-gray-100 px-8 py-3 rounded-full font-bold shadow-lg transition">
