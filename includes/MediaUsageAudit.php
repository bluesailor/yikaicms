...
final class MediaUsageAudit
{
    ...
    private static function indexJson(string $json, array $source, array $targets, array &$result): void
    {
        ...
        try {
            ...
            // This row was prefiltered because it contains a selected media URL.
            // Treat an unreadable candidate as unsafe instead of deleting blindly.
            throw new RuntimeException('Malformed media reference document', 0, $e);
        }
    ...
    private static function referenceKey(string $url): string
    {
        ...
        if (function_exists('siteBaseUrl')) {
            ...
            $siteHost = strtolower((string) parse_url('http://' . (string) $_SERVER['HTTP_HOST'], PHP_URL_HOST));
        }
