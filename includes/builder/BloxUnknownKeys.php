...
final class BloxUnknownKeys
{
    ...
    public const RESERVED = ['children', 'template', '_classes', '_global_style', '_global_style_snapshot', '_hide_on', '_home_about_i18n', '_home_faq_i18n', '_home_faq_edit', '_home_about_edit', '_home_banner_i18n', '_home_banner_edit', '_home_testimonials_i18n', '_home_testimonials_edit'];
