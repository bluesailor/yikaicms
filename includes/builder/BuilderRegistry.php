...
final class BuilderRegistry
{
    ...
    public static function boot(): void
    {
        ...
        foreach ([
            ...
            new ArticleFieldElement('cover'),
            new ArticleFieldElement('meta'),
            new ArticleFieldElement('content'),
            new ArticleFieldElement('prev-next'),
            new ArticleFieldElement('related'),
            new TextElement(),
            new ImageElement(),
            new ButtonElement(),
            new IconElement(),
