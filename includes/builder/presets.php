        ...
        'sections' => [
            ...
            [
                ...
                'sections' => [[
                    ...
                    'columns' => [
                        ['id' => 'c', 'elements' => [
                            ['id' => 'e', 'type' => 'card', 'data' => ['image' => '/images/company-about-v2.webp', 'title' => __('blox_ps_m1_t'), 'text' => __('blox_ps_m1_x'), 'link' => '']],
                        ]],
                        ['id' => 'c', 'elements' => [
                            ['id' => 'e', 'type' => 'card', 'data' => ['image' => '/images/company-about-v2.webp', 'title' => __('blox_ps_m2_t'), 'text' => __('blox_ps_m2_x'), 'link' => '']],
                        ]],
                        ['id' => 'c', 'elements' => [
                            ['id' => 'e', 'type' => 'card', 'data' => ['image' => '/images/company-about-v2.webp', 'title' => __('blox_ps_m3_t'), 'text' => __('blox_ps_m3_x'), 'link' => '']],
                        ]],
                    ],
                ]],
            ],
            [
                ...
                'sections' => [[
                    ...
                    'columns' => [
                        ['id' => 'c', 'elements' => [
                            ['id' => 'e', 'type' => 'image', 'data' => ['src' => '/images/company-about-v2.webp', 'alt' => '', 'click_action' => 'lightbox', 'link_url' => '', 'link_new_tab' => false]],
                        ]],
                        ['id' => 'c', 'elements' => [
                            ['id' => 'e', 'type' => 'image', 'data' => ['src' => '/images/company-about-v2.webp', 'alt' => '', 'click_action' => 'lightbox', 'link_url' => '', 'link_new_tab' => false]],
                        ]],
            ...
            [
                ...
                'sections' => [
                    ...
                    [
                        ...
                        'columns' => [
                            ['id' => 'c', 'elements' => [
                                ['id' => 'e', 'type' => 'image', 'data' => ['src' => '/images/company-about-v2.webp', 'alt' => __('blox_ps_co_alt'), 'click_action' => '', 'link_url' => '', 'link_new_tab' => false]],
                            ]],
                            ['id' => 'c', 'elements' => [
