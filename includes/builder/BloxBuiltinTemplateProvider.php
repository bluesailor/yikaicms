...
final class BloxBuiltinTemplateProvider
{
    private const PRESETS = [
        ...
        'hero-split' => [
            'type' => 'section',
            'file' => 'hero-split.json',
            'contexts' => ['page', 'home'],
            'name_key' => 'blox_builtin_section_hero_split_name',
            'description_key' => 'blox_builtin_section_hero_split_desc',
            'keywords_key' => 'blox_builtin_section_hero_split_keywords',
            'category' => 'landing',
            'thumbnail' => '/assets/images/blox-templates/section-hero-intro.png',
            'metadata' => [
                'purpose' => 'hero', 'variant' => 'split', 'page_types' => ['home', 'landing', 'product-detail', 'service'],
                'content_slots' => ['heading', 'text', 'image', 'button'], 'cta_type' => 'learn-more', 'image_ratio' => '4:3', 'priority' => 97,
            ],
        ],
        'feature-cards-soft' => [
            'type' => 'section',
            'file' => 'feature-cards-soft.json',
            'contexts' => ['page', 'home'],
            'name_key' => 'blox_builtin_section_feature_cards_name',
            'description_key' => 'blox_builtin_section_feature_cards_desc',
            'keywords_key' => 'blox_builtin_section_feature_cards_keywords',
            'category' => 'marketing',
            'thumbnail' => '/assets/images/blox-templates/section-feature-grid.png',
            'metadata' => [
                'purpose' => 'features', 'variant' => 'cards', 'page_types' => ['home', 'about', 'service', 'landing'],
                'content_slots' => ['heading', 'icon', 'text', 'button'], 'cta_type' => 'learn-more', 'priority' => 91,
            ],
        ],
        'faq-split' => [
            'type' => 'section',
            'file' => 'faq-split.json',
            'contexts' => ['page', 'home'],
            'name_key' => 'blox_builtin_section_faq_split_name',
            'description_key' => 'blox_builtin_section_faq_split_desc',
            'keywords_key' => 'blox_builtin_section_faq_split_keywords',
            'category' => 'content',
            'thumbnail' => '/assets/images/blox-templates/section-faq-accordion.png',
            'metadata' => [
                'purpose' => 'faq', 'variant' => 'side-by-side', 'page_types' => ['general', 'service', 'contact', 'product-detail', 'landing'],
                'content_slots' => ['heading', 'text', 'image', 'faq'], 'priority' => 89,
            ],
        ],
        'testimonial-grid' => [
            'type' => 'section',
            'file' => 'testimonial-grid.json',
            'contexts' => ['page', 'home'],
            'name_key' => 'blox_builtin_section_testimonial_grid_name',
            'description_key' => 'blox_builtin_section_testimonial_grid_desc',
            'keywords_key' => 'blox_builtin_section_testimonial_grid_keywords',
            'category' => 'marketing',
            'thumbnail' => '/assets/images/blox-templates/section-testimonial-quote.png',
            'metadata' => [
                'purpose' => 'testimonials', 'variant' => 'cards', 'page_types' => ['home', 'about', 'case', 'landing'],
                'content_slots' => ['heading', 'quote', 'author'], 'priority' => 84,
            ],
        ],
        'cta-split' => [
            'type' => 'section',
            ...
            'thumbnail' => '/assets/images/blox-templates/section-cta-banner.png',
            'metadata' => [
                'purpose' => 'cta', 'variant' => 'split', 'page_types' => ['general', 'home', 'about', 'service', 'contact', 'landing'],
                'content_slots' => ['heading', 'text', 'image', 'button'], 'cta_type' => 'contact', 'priority' => 88,
            ],
        ],
        'logo-cloud-minimal' => [
            'type' => 'section',
            'file' => 'logo-cloud-minimal.json',
            'contexts' => ['page', 'home'],
            'name_key' => 'blox_builtin_section_logo_cloud_name',
            'description_key' => 'blox_builtin_section_logo_cloud_desc',
            'keywords_key' => 'blox_builtin_section_logo_cloud_keywords',
            'category' => 'business',
            'thumbnail' => '/assets/images/blox-templates/section-client-logo-wall.png',
            'metadata' => [
                'purpose' => 'testimonials', 'variant' => 'minimal', 'page_types' => ['home', 'about', 'case', 'landing'],
                'content_slots' => ['heading', 'logos', 'text'], 'priority' => 81,
            ],
        ],
        'product-grid-dynamic' => [
            'type' => 'section',
            'file' => 'product-grid-dynamic.json',
            'contexts' => ['page', 'home'],
            'name_key' => 'blox_builtin_section_product_dynamic_name',
            'description_key' => 'blox_builtin_section_product_dynamic_desc',
            'keywords_key' => 'blox_builtin_section_product_dynamic_keywords',
            'category' => 'business',
            'thumbnail' => '/assets/images/blox-templates/section-product-comparison.png',
            'metadata' => [
                'purpose' => 'products', 'variant' => 'dynamic', 'data_source' => 'dynamic', 'states' => ['loading', 'empty', 'error'],
                'page_types' => ['home', 'product-list', 'landing'], 'content_slots' => ['heading', 'products', 'button'], 'priority' => 99,
            ],
        ],
        'case-grid-dynamic' => [
            'type' => 'section',
            'file' => 'case-grid-dynamic.json',
            'contexts' => ['page', 'home'],
            'name_key' => 'blox_builtin_section_case_dynamic_name',
            'description_key' => 'blox_builtin_section_case_dynamic_desc',
            'keywords_key' => 'blox_builtin_section_case_dynamic_keywords',
            'category' => 'business',
            'thumbnail' => '/assets/images/blox-templates/section-case-grid.png',
            'metadata' => [
                'purpose' => 'cases', 'variant' => 'dynamic', 'data_source' => 'dynamic', 'states' => ['loading', 'empty', 'error'],
                'page_types' => ['home', 'case', 'landing'], 'content_slots' => ['heading', 'cases', 'button'], 'priority' => 98,
            ],
        ],
        'article-grid-dynamic' => [
            'type' => 'section',
            'file' => 'article-grid-dynamic.json',
            'contexts' => ['page', 'home'],
            'name_key' => 'blox_builtin_section_article_dynamic_name',
            'description_key' => 'blox_builtin_section_article_dynamic_desc',
            'keywords_key' => 'blox_builtin_section_article_dynamic_keywords',
            'category' => 'content',
            'thumbnail' => '/assets/images/blox-templates/section-card-grid.jpg',
            'metadata' => [
                'purpose' => 'content', 'variant' => 'dynamic', 'data_source' => 'dynamic', 'states' => ['loading', 'empty', 'error'],
                'page_types' => ['home', 'content-list', 'landing'], 'content_slots' => ['heading', 'articles', 'button'], 'priority' => 93,
            ],
        ],
        'company-intro' => [
            'type' => 'page',
        ...
        'brand-service-landing' => [
            'type' => 'page',
            'file' => 'brand-service-landing.json',
            'contexts' => ['page'],
            'name_key' => 'blox_builtin_landing_name',
            'description_key' => 'blox_builtin_landing_desc',
            'keywords_key' => 'blox_builtin_landing_keywords',
            'category' => 'page',
            'thumbnail' => '/assets/images/blox-templates/landing-brand-hero.png',
            'metadata' => [
                'purpose' => 'landing',
                'page_types' => ['landing', 'general', 'home', 'about', 'service', 'product-detail'],
                'content_slots' => ['heading', 'text', 'image', 'cards', 'form', 'faq', 'button'],
                'cta_type' => 'contact',
                'image_ratio' => '16:9',
                'priority' => 98,
            ],
        ...
        'restaurant-landing' => [
            'type' => 'page',
            'file' => 'restaurant-landing.json',
            'contexts' => ['page'],
            'name_key' => 'blox_builtin_restaurant_name',
            'description_key' => 'blox_builtin_restaurant_desc',
            'keywords_key' => 'blox_builtin_restaurant_keywords',
            'category' => 'page',
            'thumbnail' => '/assets/images/blox-templates/restaurant-braised-pork.webp',
            'metadata' => [
                'purpose' => 'landing',
                'page_types' => ['landing', 'general', 'home'],
                'content_slots' => ['heading', 'text', 'image', 'cards', 'form', 'faq', 'button'],
                'cta_type' => 'contact',
                'image_ratio' => '3:2',
                'priority' => 97,
