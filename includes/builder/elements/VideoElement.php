...
final class VideoElement extends AbstractElement
{
    ...
    public function render(array $data, string $children = ''): string
    {
        ...
        return '<div class="my-4"><video class="ykt-plyr" playsinline controls src="' . htmlspecialchars($fileUrl) . '"></video></div>'
            ...
            . 'var c=document.createElement("link");c.rel="stylesheet";c.href=(window.YK_BASE || "") + "/assets/plyr/plyr.min.css";document.head.appendChild(c);'
            . 'var s=document.createElement("script");s.src=(window.YK_BASE || "") + "/assets/plyr/plyr.min.js";'
