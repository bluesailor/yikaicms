...
final class ThemeSettings
{
    ...
    public static function css(): string
    {
        ...
        $css .= '@media (max-width:' . $r['tablet'] . 'px){.yk-site-body .container{max-width:100%;}}@media (max-width:' . $r['mobile'] . 'px){:root{--yk-section-padding-y:' . max(32, (int) $sp['section_padding_y'] / 2) . 'px;}}';
