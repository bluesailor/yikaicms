<?php
/**
 * Article grid card used by the Blox content catalog (core fallback).
 *
 * theme_path() falls back here for themes without their own copy (business / minimal):
 * without it a grid content catalog fatals on those themes.
 */
