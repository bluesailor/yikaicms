...
// 首页只有一个编辑入口：可视化编辑器可用时直达它，经典首页设置收在建站向导的「旧版首页选项」里
require_once ROOT_PATH . '/includes/SiteSetup.php';
$_homeEditUrl = SiteSetup::homeEditUrl();
            ...
            <div x-show="tab==='main'" x-cloak>
                ...
                <div class="px-4 pt-4">
                    <div class="flex items-center gap-3 px-4 py-3 bg-blue-50 rounded-lg border border-blue-200">
                        ...
                        <a href="<?php echo e($_homeEditUrl); ?>" class="text-primary hover:underline text-sm"><?php echo __('admin_edit'); ?></a>
                    </div>
                </div>
