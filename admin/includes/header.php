...
$sidebarGroups = [
    ...
    'system'  => ['setting', 'setting_home', 'setting_contact', 'setting_email', 'setting_seo', 'translate', 'setting_security', 'user', 'role', 'log', 'system', 'upgrade', 'online_upgrade', 'plugin', 'system_log'],
];
$activeGroup = '';
