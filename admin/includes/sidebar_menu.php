...
return [
    ...
    'design' => [
        'label'    => __('admin_group_design'),
        'icon'     => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v18m9-9H3m15.364-6.364L5.636 18.364m12.728 0L5.636 5.636"></path>',
        'priority' => 65,
        'items'    => [
            [
                'key'         => 'site_design',
    ...
    'appearance' => [
        ...
        'items'    => [
            [
                ...
                'icon'  => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7V4h16v3M9 20h6M12 4v16"></path>',
            ],
            [
                'key'   => 'theme',
                'perm'  => '*',
    ...
    'system' => [
        ...
        'items'      => [
            ...
            [
                'key'   => 'setting_api',
                'label' => __('admin_setting_api'),
                'url'   => '/admin/setting_api.php',
