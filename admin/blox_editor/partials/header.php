    ...
    <details class="border-b border-gray-200 bg-white px-4 py-2 text-sm" data-testid="product-template-settings">
        ...
        <div class="flex flex-wrap items-end gap-4 py-3">
            <label>
                ...
                <input readonly :value="templateLanguageLabel()" data-testid="product-template-language" class="w-28 border border-gray-300 rounded px-2 py-2">
            </label>
        </div>
    ...
    <details class="border-b border-gray-200 bg-white px-4 py-2 text-sm" data-testid="article-template-settings">
        ...
        <div class="flex flex-wrap items-end gap-4 py-3">
            <label>
                ...
                <input readonly :value="templateLanguageLabel()" data-testid="article-template-language" class="w-28 border border-gray-300 rounded px-2 py-2">
            </label>
        </div>
