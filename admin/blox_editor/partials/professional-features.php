...
<details class="border-b border-gray-100 px-3 py-2 text-xs" data-testid="blox-professional-features"
         x-show="!selectedSectionField && (professionalRelevant('query_loop') || professionalRelevant('display_conditions') || professionalRelevant('style_presets') || professionalRelevant('table'))"
    ...
    <div class="space-y-3 pt-2 pb-1">
        <?php foreach (['query_loop' => 'blox_professional_dynamic', 'display_conditions' => 'blox_professional_conditions', 'style_presets' => 'blox_global_style', 'table' => 'blox_el_table'] as $feature => $label): ?>
