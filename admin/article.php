...
<div class="bg-white rounded-lg shadow">
                ...
                <tr class="hover:bg-gray-50" id="row-<?php echo $item['id']; ?>">
                    ...
                    <td class="px-4 py-3">
                        <button onclick="toggleTop(<?php echo $item['id']; ?>)" class="top-btn-<?php echo $item['id']; ?>">
                            <?php echo $item['is_top'] ? '<span class="text-red-500">是</span>' : '<span class="text-gray-300">否</span>'; ?>
                        </button>
                    </td>
                    <td class="px-4 py-3">
                        <button onclick="toggleRecommend(<?php echo $item['id']; ?>)" class="rec-btn-<?php echo $item['id']; ?>">
                            <?php echo $item['is_recommend'] ? '<span class="text-orange-500">是</span>' : '<span class="text-gray-300">否</span>'; ?>
                        </button>
                    </td>
    ...
    <div class="px-4 py-3 border-t flex items-center justify-between">
        ...
        <div class="flex items-center gap-2 text-sm">
            ...
            ?>
            <?php if ($page > 1): ?>
            <a href="?page=<?php echo $page - 1; ?>&<?php echo $qstr; ?>" class="px-3 py-1 border rounded hover:bg-gray-50">上一页</a>
            <?php endif; ?>
            <?php if ($page < $totalPages): ?>
            <a href="?page=<?php echo $page + 1; ?>&<?php echo $qstr; ?>" class="px-3 py-1 border rounded hover:bg-gray-50">下一页</a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
    </div>
