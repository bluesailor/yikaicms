        ...
        <div class="flex flex-wrap lg:flex-nowrap gap-8" data-product-catalog-layout>
            ...
            <div class="w-full lg:w-64 flex-shrink-0 space-y-4" data-product-catalog-sidebar>
                ...
                <div class="bg-white rounded-lg shadow p-4" data-catalog-search>
                    <form method="get" action="<?php echo ($isProductType && isDynamicUrlMode()) ? '/index.php' : channelUrl($channel); ?>">
            ...
            <div class="flex-1 min-w-0">
                ...
                <form method="get" action="<?php echo ($isProductType && isDynamicUrlMode()) ? '/index.php' : channelUrl($channel); ?>" class="mb-6 flex items-center gap-2 max-w-md">
                    <?php if ($isProductType && isDynamicUrlMode()): ?>
                    <input type="hidden" name="yk_route" value="product_list">
                    <?php endif; ?>
                    <?php if ($isProductType && $productCategory && !empty($productCategory['slug'])): ?>
